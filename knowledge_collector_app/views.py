...
projects = [
    {'name': 'Spelling Bee Mania!', 'image': '', 'technologies': 'HTML, CSS, Javascript', 'description': 'An interactive spelling bee game powered by computer generated voice technology, allowing the user to simulate a realistic spelling bee experience!', 'live': 'https://julibennett.github.io/Project_1_SpellingBee/', 'date': 'January 2024'},
